    ...
    <el-aside width="240px" class="aside">
      <div class="brand">
        ...
        <div class="brand-text">
          <span class="brand-title">直约服务商</span>
          <span class="brand-sub">商家管理台</span>
        </div>
      </div>
...
import { Odometer, Shop, Goods, List, OfficeBuilding, Refresh, TrendCharts } from '@element-plus/icons-vue'
...
async function loadProfile() {
  try {
    store.initProfileFromStorage()
    if (store.profile) {
      profile.shop_name = store.profile.shop_name || ''
      profile.community_id = store.profile.community_id
    }
