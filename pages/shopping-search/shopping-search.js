...
Page({
  ...
  loadGuess() {
    // 模拟或调用最近浏览的拉取逻辑
    const guess = [
      { id: 1001, name: "居家常备好物", image: "/img/placeholders/home_cleaning.png" },
      { id: 1002, name: "智能保温杯", image: "/img/placeholders/home_cleaning.png" }
    ];
    this.setData({ guess });
  },
  ...
  mockResults() {
    ...
    if (this.data.searchMode === 'goods') {
      this.setData({
        results: [
          { id: 200, name: `[商品] 搜索到的 ${this.data.keyword}`, price: "59.90", origPrice: "99.00", sales: 456, image: "/img/placeholders/home_cleaning.png" },
          { id: 201, name: "本地土鸡蛋30枚", price: "29.90", sales: 2011, image: "/img/placeholders/home_cleaning.png" }
        ]
      });
    } else {
      this.setData({
        results: [
          { 
            ...
            goods: [ { image: "/img/placeholders/home_cleaning.png" }, { image: "/img/placeholders/home_cleaning.png" } ]
          }
        ]
      });
    }
