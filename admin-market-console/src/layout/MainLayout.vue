...
import { Odometer, Shop, Goods, List, Money, SwitchButton, ChatDotRound, TrendCharts } from '@element-plus/icons-vue'
import { useMarketConsoleStore } from '../stores/marketConsole'

const route = useRoute()
const router = useRouter()
const store = useMarketConsoleStore()
const shopName = computed(() => store.shop?.name || '')
const asideW = '232px'
...
const activeMenu = computed(() => {
  ...
  if (p === '/help' || p === '/notifications' || p === '/analytics') return p
  return p
})
