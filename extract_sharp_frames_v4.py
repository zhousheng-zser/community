#!/usr/bin/env python3
"""
Extract the sharpest frame from every consecutive 25-frame group.
All frames are read; for each group of 25 consecutive frames,
...
def main(video_path, output_dir, group_size=25):
...
if __name__ == "__main__":
    ...
    OUT = "/home/cw/a/community-backend/aaa/sharp_frames2"
    main(VIDEO, OUT, group_size=25)
